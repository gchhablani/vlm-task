#!/bin/bash
#SBATCH --job-name=imagenav-cache
...
TENSORBOARD_DIR="tb/imagenav/vc1_cached_4/seed_1/"
CHECKPOINT_DIR="data/new_checkpoints/vc1_cached_4/seed_1/"
...
srun python -um vlm.run \
  ...
  +habitat/task/lab_sensors@habitat.task.lab_sensors.cache_imagegoal_sensor=cache_imagegoal_sensor \
  ~habitat.task.lab_sensors.imagegoal_sensor \
